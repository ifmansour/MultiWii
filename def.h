...
// Orig  
  ...
  #define ACC_ORIENTATION_AIR(X, Y, Z)  {imu.accADC[ROLL]  = -X; imu.accADC[PITCH]  = -Y; imu.accADC[YAW]  =  Z;}
  #define GYRO_ORIENTATION_AIR(X, Y, Z) {imu.gyroADC[ROLL] =  Y; imu.gyroADC[PITCH] = -X; imu.gyroADC[YAW] = -Z;}
  #define MAG_ORIENTATION_AIR(X, Y, Z)  {imu.magADC[ROLL]  =  X; imu.magADC[PITCH]  =  Y; imu.magADC[YAW]  = -Z;}
 
  //#define ACC_ORIENTATION_UNDERWATER(X, Y, Z)  {imu.accADC[ROLL]  = -X; imu.accADC[PITCH]  = -Z; imu.accADC[YAW]  = -Y;}
  #define ACC_ORIENTATION_UNDERWATER(X, Y, Z)  {imu.accADC[ROLL]  = -X; imu.accADC[PITCH]  = -Y; imu.accADC[YAW]  = -Y;}
  //#define GYRO_ORIENTATION_UNDERWATER(X, Y, Z) {imu.gyroADC[ROLL] =  Z; imu.gyroADC[PITCH] = -X; imu.gyroADC[YAW] = Y;}
  #define GYRO_ORIENTATION_UNDERWATER(X, Y, Z) {imu.gyroADC[ROLL] =  Y; imu.gyroADC[PITCH] = -X; imu.gyroADC[YAW] = -Z;}
  #define MAG_ORIENTATION_UNDERWATER(X, Y, Z)  {imu.magADC[ROLL]  =  -Z; imu.magADC[PITCH]  =  Y; imu.magADC[YAW]  = -X;}

  //#define MAG_ORIENTATION_UNDERWATER(X, Y, Z)  {imu.magADC[ROLL]  =  X; imu.magADC[PITCH]  =  Y; imu.magADC[YAW]  = -Z;}
